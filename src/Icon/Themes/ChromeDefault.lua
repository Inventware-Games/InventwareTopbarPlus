--[[
This file is necessary for constructing the default Icon template for the new Chrome UI Topbar
Do not remove this module otherwise TopbarPlus will break, assuming IconController.chromeUiEnabled is set to true
